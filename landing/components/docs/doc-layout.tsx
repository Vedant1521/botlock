    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-20 pb-20">
      <div className="flex gap-10 min-h-screen">
        ...
        <aside className="hidden lg:flex flex-col w-56 shrink-0 pt-10">
          {/* SDK switcher */}
          <div className="mb-6 rounded-xl border border-gray-200 dark:border-border bg-gray-50 dark:bg-surface overflow-hidden">
            <Link
              href="/docs/publisher"
              className={`flex items-center gap-2.5 px-3 py-2.5 text-sm transition-colors ${
                pathname === "/docs/publisher"
                  ? "bg-accent/10 text-accent"
                  : "text-gray-600 dark:text-inkMuted hover:text-black dark:hover:text-ink hover:bg-gray-100 dark:hover:bg-raised"
              }`}
            >
              ...
              <a
                ...
                className={`flex items-center gap-2 px-2 py-1.5 rounded-md text-xs transition-colors ${
                  activeId === s.id
                    ...
                    : "text-gray-400 dark:text-inkSubtle hover:text-gray-600 dark:hover:text-inkMuted"
                }`}
              >
                {activeId === s.id && (
