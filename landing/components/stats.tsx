  ...
  return (
    <section className="relative py-20 sm:py-24 border-t border-gray-200 dark:border-border">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 dark:bg-border rounded-2xl overflow-hidden border border-gray-200 dark:border-border">
          {STATS.map((stat, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white dark:bg-surface p-8 sm:p-10 flex flex-col items-center text-center transition-colors hover:bg-gray-50 dark:hover:bg-raised"
              >
                ...
                <div className="text-4xl sm:text-5xl font-bold text-black dark:text-ink tracking-tight tabular-nums">
                  {stat.value}
                </div>
